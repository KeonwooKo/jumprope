...
export function PositionLoading({
  open,
  phase,
  status,
  errorMsg,
    ...
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute top-[50px] left-3.5 right-3.5 flex justify-between items-center z-10">
        <button
          type="button"
          onClick={onClose}
          className="w-[34px] h-[34px] rounded-full grid place-items-center bg-black/40 border-[1.5px] border-white/30 text-white"
          aria-label="닫기"
        >
        ...
        <div
          className={
            ...
            (ok
              ? "bg-[rgba(43,214,123,0.3)] border-[rgba(43,214,123,0.5)]"
      ...
      {/* Focus box */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[78%] aspect-[4/6] rounded-[22px] border-[2.5px] border-dashed z-[2] animate-pulse"
      ...
      <div className="absolute bottom-[148px] left-1/2 -translate-x-1/2 z-10">
        <div
          className={
            ...
            (ok
              ? "border-[#00864a] text-[#0a6339] shadow-[0_4px_0_rgba(0,134,74,0.2)]"
              : "border-[#b07600] text-[#704b00] shadow-[0_4px_0_rgba(176,118,0,0.2)]")
          }
        >
          {bubbleText}
          <span
            className={
              "absolute -bottom-[8px] left-6 w-3 h-3 bg-white rotate-45 border-r-2 border-b-2 " +
              (ok ? "border-[#00864a]" : "border-[#b07600]")
            }
          />
        </div>
      </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 px-[18px] pt-4 pb-[26px] z-10 bg-[linear-gradient(180deg,transparent,rgba(0,0,0,0.75))]">
        <div className="relative bg-black/60 backdrop-blur-md border-[1.5px] border-white/15 rounded-[14px] px-3.5 py-2.5 flex items-center gap-2.5 mb-2.5 overflow-hidden">
          {isHolding && (
            <div
              className="absolute top-0 left-0 h-[3px] bg-[#2bd67b] transition-[width] duration-100 ease-linear"
